...
V3_STAGE0_SKELETON = "v3_stage0_skeleton"
V3_STAGE1B_COMMITMENTS = "v3_stage1b_commitments"
V3_SKELETON_EDITOR = "v3_skeleton_editor"
...
V3_NODE_SLOTS: dict[str, ModelSlot] = {
    ...
    V3_STAGE0_SKELETON: ModelSlot.FAST,
    V3_STAGE1B_COMMITMENTS: ModelSlot.FAST,
    V3_SKELETON_EDITOR: ModelSlot.FAST,
...
V3_NODE_REASONING: dict[str, V3NodeReasoningPolicy] = {
    ...
    V3_STAGE0_SKELETON: False,
    V3_STAGE1B_COMMITMENTS: False,
    V3_SKELETON_EDITOR: False,
