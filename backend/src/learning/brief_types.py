...
class ClassProfile(BaseModel):
    ...
    @classmethod
    def _dedupe_learning_preferences(cls, value: list[ClassLearningPreference]) -> list[ClassLearningPreference]:
...
class TeacherBrief(BaseModel):
    ...
    @classmethod
    def _dedupe_supports(cls, value: list[TeacherBriefSupport]) -> list[TeacherBriefSupport]:
        return list(dict.fromkeys(value))
