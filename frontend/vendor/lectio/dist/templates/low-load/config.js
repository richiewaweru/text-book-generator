import { lowLoadPresetIds } from './presets';
export const lowLoadContract = {
    id: 'low-load',
    name: 'Low Load',
    ...
    notIdealFor: ['dense comparison lessons', 'topics that require multiple simultaneous visuals'],
    ...
    allowedPresets: [...lowLoadPresetIds],
    whyThisTemplateExists: 'Accommodation is not only a color choice. This template structurally lowers cognitive load by removing simultaneous competition on the page.',
    generationGuidance: {
